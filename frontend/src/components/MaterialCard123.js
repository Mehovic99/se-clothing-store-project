...
function MaterialCard123(props) {
  return (
    <Container {...props}>
      <LoremIpsum1>$30</LoremIpsum1>
      <CardBody1>
        <BodyContent1>
          <StrechableJeans>Strechable Jeans</StrechableJeans>
          <SubtitleStyle1>
            An item that need no description.{"\n"}A simple pair of jeans that
            contain{"\n"}highly stretchable material that{"\n"}can be fit for
            any person to wear.{"\n"}Scallope Edge Embroided Denim.
          </SubtitleStyle1>
        </BodyContent1>
        <CardItemImagePlace1
          src={require("../assets/images/jeans.png")}
        ></CardItemImagePlace1>
      </CardBody1>
      <ActionBody1>
        <ActionButton1>
...
const StrechableJeans = styled.span`
  font-family: Roboto;
  font-size: 24px;
  color: #000;
  padding-bottom: 12px;
