...
function MaterialCard125(props) {
  return (
    <Container {...props}>
      <CardBody1>
        <BodyContent1>
          <ModernRedJoggers>Modern Red Joggers</ModernRedJoggers>
          <SubtitleStyle1>
            A refreshing take on a classic piece{"\n"}of workout wear. A new
            look with{"\n"}beasels near the shin and a{"\n"}wonderful splash of
            color to add to{"\n"}your daily wear. 100% cotton
          </SubtitleStyle1>
        </BodyContent1>
        <CardItemImagePlace1
          src={require("../assets/images/red_joggers.png")}
        ></CardItemImagePlace1>
      </CardBody1>
      <ActionBody1>
        <ActionButton1>
...
const ModernRedJoggers = styled.span`
  font-family: Roboto;
  font-size: 24px;
  color: #000;
  padding-bottom: 12px;
