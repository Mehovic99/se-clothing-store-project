...
function MaterialCard124(props) {
  return (
    <Container {...props}>
      <LoremIpsum1>$65</LoremIpsum1>
      <CardBody1>
        <BodyContent1>
          <TitleStyle1>Converse Black{"\n"}Sneakers</TitleStyle1>
          <SubtitleStyle1>
            A classic pair of shoes in the{"\n"}sneaker world. These pair of
            shoes{"\n"}Are a testament to time itself.
          </SubtitleStyle1>
        </BodyContent1>
        <CardItemImagePlace1
          src={require("../assets/images/sneakers.png")}
        ></CardItemImagePlace1>
      </CardBody1>
      <ActionBody1>
        <ActionButton1>
