...
function MaterialCard121(props) {
  return (
    <Container {...props}>
      <CardBody1>
        <BodyContent1>
          <TitleStyle1>Simplistic Black{"\n"}Coat</TitleStyle1>
          <SubtitleStyle1>
            A simple black coat that can{"\n"}be fashinable with multiple{"\n"}
            formal wears. 100% Cotton
          </SubtitleStyle1>
        </BodyContent1>
        <CardItemImagePlace1
          src={require("../assets/images/Black_Coat2.png")}
        ></CardItemImagePlace1>
      </CardBody1>
      <ActionBody1>
        <ActionButton1>
